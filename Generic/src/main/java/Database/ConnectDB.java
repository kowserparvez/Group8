...
/**
 * Created by Sayed Siddeque on 04/20/18.
 */
...
public class ConnectDB {
    ...
    public Properties loadProperties() throws IOException{
        ...
        InputStream ism = new FileInputStream("/Users/sayedsiddeque/Development/Group8/Generic/databaseinfo/Secrate.properties");
        prop.load(ism);
        ism.close();
        return prop;
    }
